/** Package invariant companion. @module @deepseek-ai/dsh-wanwei-oneapi-auth/invariant */
import type { Context } from '@deepseek-ai/cordis'
import type { InvariantInstaller } from '@deepseek-ai/dsh-invariants'

const PACKAGE_NAME = '@deepseek-ai/dsh-wanwei-oneapi-auth'
/** Cordis companion name. */
export const name = 'wanwei-oneapi-auth-invariant'
