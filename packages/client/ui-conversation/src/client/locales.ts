...
export const zh = {
  ...
  'placeholder.workspace': '可先输入内容，选择工作区后发送',
  'input.commands': '命令',
  'input.stop': '停止生成',
  'input.send': '发送消息',
  ...
  'file.dropDesc': '图片最多 {count} 张，每张 {size}；其他文件将复制到工作区',
  'image.pending': '待发送图片',
  ...
  'tool.title.read': '读取文件 · Read',
  'tool.title.bash': '运行命令 · Bash',
  'tool.title.write': '写入文件 · Write',
  'tool.title.edit': '编辑文件 · Edit',
  'tool.title.code': '运行代码 · Code',
  'tool.title.others': '工具调用 · {name}',
  'tool.title.pwsh': '运行 PowerShell · Pwsh',
  'tool.title.grep': '搜索文本 · Grep',
  'tool.title.glob': '搜索文件 · Glob',
  'tool.title.webSearch': '网络搜索 · Web Search',
  'tool.title.webFetch': '读取网页 · Web Fetch',
  'tool.title.inspect': '检查运行时',
  'tool.title.cordisRun': '运行 Cordis 插件',
  'tool.title.cordisStop': '停止 Cordis 插件',
  'tool.title.cordisRemove': '移除 Cordis 插件',
  'clock.md': '{m}月{d}日',
...
export const en = {
  ...
  'placeholder.workspace': 'Type now, then choose a workspace to send',
  ...
  'file.dropDesc': 'Up to {count} images, {size} each; other files are copied to the workspace',
  ...
  'hero.preview': 'Professional AI Assistant',
  ...
  'tool.title.others': 'Tool call · {name}',
  ...
  'tool.title.cordisRemove': 'Remove Cordis Plugin',
  'clock.md': '{m}/{d}',
  'clock.ymd': '{y}-{m}-{d}',
