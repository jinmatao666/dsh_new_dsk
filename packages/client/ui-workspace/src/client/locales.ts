...
export const zh = {
  ...
  'workspace.add': '添加工作区',
  'workspace.drop.ready': '松开以导入到当前工作区',
  'workspace.drop.importing': '正在导入文件…',
  'workspace.drop.noTarget': '请先打开一个已关联工作区的会话，再拖入文件。',
  'workspace.drop.success.one': '已导入 {n} 个文件',
  'workspace.drop.success.other': '已导入 {n} 个文件',
  'workspace.drop.failed': '文件导入失败：{message}',
  ...
  'workspace.open.failed': '打开工作区失败：{message}',
...
export const en = {
  ...
  'workspace.drop.ready': 'Release to import into the current workspace',
  'workspace.drop.importing': 'Importing files…',
  'workspace.drop.noTarget': 'Open a session linked to a workspace before dropping files.',
  'workspace.drop.success.one': 'Imported {n} file',
  'workspace.drop.success.other': 'Imported {n} files',
  'workspace.drop.failed': 'Could not import files: {message}',
  ...
  'workspace.open.failed': 'Failed to open workspace: {message}',
