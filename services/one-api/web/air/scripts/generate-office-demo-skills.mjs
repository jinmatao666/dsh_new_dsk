...
- 图片较多时提供报告和目录链接，不在对话中铺满所有图片。`,
  },
  {
    ...
    capabilities: ['Qwen3-ASR 或后台百炼 Qwen-Audio 语音转写', '音频转 WAV 与长录音分段转写', 'Qwen3.8 结构化会议纪要', 'Markdown 与 Word 交付'],
    params: [fileList('materials', '可选会议材料或已有转写稿', false), fileParam('audioPath', '可选 WAV、M4A、MP3 等语音文件；长音频自动分段转写', false), stringParam('meetingTitle', '会议名称', false), outputDirectory()],
...
function fileList(name, description, required = true) { return { name, type: 'files', required, description }; }
