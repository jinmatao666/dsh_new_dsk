...
Focused approval and deliverable tests cover the session grant, source-file exclusion, and analysis-view rendering. GIS invocation checks cover GeoJSON, Shape ZIP, Shape directory, and direct Shape-file inputs, including timestamped JSON, Markdown, analysis-view, Excel, and Word artifacts. Catalog validation checks identifiers, versions, declared files, and path containment. Native tests cover complete-directory installation, authenticated-server package installation, updates, legacy migration, custom-directory validation, ownership refusal, removal, and restricted analysis-view reads. Type checking covers the marketplace, approval, and deliverables packages; Rust checks cover the desktop native commands.
